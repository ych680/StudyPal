...
import { Text, View, TouchableOpacity, SafeAreaView, TextInput, Platform, StatusBar, Alert, Dimensions, ActivityIndicator, ScrollView } from 'react-native';
      ...
      >
        ...
        <View style={styles.signupContainer}>
          ...
          <TouchableOpacity onPress={() => onGoogleButtonPress().then(() => console.log('Signed in with Google!'))}>
            {loading ? <ActivityIndicator size="large" color="#0000ff" /> : <GoogleSignup style={styles.googleSignup} />}
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
